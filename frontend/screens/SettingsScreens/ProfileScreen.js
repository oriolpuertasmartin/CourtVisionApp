    ...
    const pickImage = async () => {
        ...
        if (!result.canceled && result.assets[0].base64) {
            ...
            if (base64Data.length > 1000000) {
                Alert.alert("Image too large", "Please select a smaller image (under 1MB).");
                return;
            }
                    ...
                    <View style={styles.infoSection}>
                        ...
                        {isEditing ? (
                            <TextInput
                                ...
                                onChangeText={(text) => setEditableUser(prev => ({...prev, name: text}))}
                    ...
                    <View style={styles.infoSection}>
                        ...
                        {isEditing ? (
                            <TextInput
                                ...
                                onChangeText={(text) => setEditableUser(prev => ({...prev, username: text}))}
                    ...
                    <View style={styles.infoSection}>
                        ...
                        {isEditing ? (
                            <TextInput
                                ...
                                onChangeText={(text) => setEditableUser(prev => ({...prev, email: text}))}
